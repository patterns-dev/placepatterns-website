...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments"><?php comments_number('<span>' . __("No","bonestheme") . '</span> ' . __("Discussion","bonestheme") . '', '<span>' . __("One","bonestheme") . '</span> ' . __("Comment","bonestheme") . '', '<span>%</span> ' . __("Comments","bonestheme") );?> <?php _e("to","bonestheme"); ?> &#8220;<?php the_title(); ?>&#8221;</h3>

	<nav id="comment-nav">
		<ul class="clearfix">
	  		<li><?php previous_comments_link( __("Older discussions","bonestheme") ) ?></li>
	  		<li><?php next_comments_link( __("Newer discussions","bonestheme") ) ?></li>
	 	</ul>
	</nav>
...
<section id="respond" class="respond-form">
	...
	<h3 id="comment-form-title"><?php comment_form_title( __("Contribute your thoughts","bonestheme"), __("Reply to","bonestheme") . ' %s' ); ?></h3>
	...
	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
  	<div class="help">
  		<p><?php _e("You must be","bonestheme"); ?> <a href="<?php echo wp_login_url( get_permalink() ); ?>"><?php _e("logged in","bonestheme"); ?></a> <?php _e("to post","bonestheme"); ?>.</p>
  	</div>
	<?php else : ?>
